...
import { FormValues } from './sign-up.container';
...
export const SignUpForm: FC<SignUpFormProps> = ({ passwordFooter, passwordHeader, errors, control, onSubmit }) => {
	return (
		<div className="form-demo">
			<div className="flex justify-content-center">
				<div className="card flex justify-content-center form-demo">
